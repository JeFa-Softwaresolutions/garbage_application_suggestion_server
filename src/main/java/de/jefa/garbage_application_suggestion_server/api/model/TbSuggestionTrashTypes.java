...
@Entity
@Table(name = "tb_suggestion_trash_types", schema = "public", catalog = "db_garbage_test")
public class TbSuggestionTrashTypes {
    ...
    public boolean equals(Object o) {
        ...
        TbSuggestionTrashTypes that = (TbSuggestionTrashTypes) o;
